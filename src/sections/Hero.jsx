...
const socials = [
  { icon: Github, href: "https://github.com/abhyush", label: "GitHub" },
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
                Hi, I’m Abhyush Rajak — a software engineer specializing in backend systems and AI agents.
                I build reliable APIs, data-driven services, and automation workflows with Node.js, Python,
                and SQL.
              </p>

              {/* LeetCode Highlights */}
              <div className="flex flex-wrap items-center gap-3 pt-1 animate-fade-in animation-delay-250">
                <span className="px-3 py-1 rounded-full glass text-sm text-muted-foreground">
